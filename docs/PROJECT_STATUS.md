...
V3.6 is committed at `bb5e07b`; V3.7 at `254e6bf`. V3.8 is pending owner
review; migration `030` adds immutable shadow validation and drift evidence.
...
Compileall and both 319-test suites passed; migration rerun applied zero and
readiness reported 13 PASS, zero FAIL and eleven optional SKIPs.
...
Review and commit V3.8. The approved next milestone remains V3.9 — Institutional
