...
V3.6 is committed at `bb5e07b`; V3.7 at `254e6bf`; V3.8 at `67ed31c`. V3.9 is
pending owner review; migration `031` adds immutable offline research governance.
...
Compileall and both 329-test suites passed; migration rerun applied zero and
readiness reported 13 PASS, zero FAIL and twelve optional SKIPs.
...
documented skips in the PostgreSQL suite. Migration `027` applied once and its
rerun applied zero changes. Release readiness reported 13 PASS, 0 FAIL and eight
optional SKIPs.
...
Review and commit V3.9. The approved next milestone remains V3.10 — Scale and
